...
function UserAuth({ handleImgBtnClick, isSignUp, isShifted }: Iprops) {
  ...
  return (
    <div className="h-[100vh] z-10 pt-7 py-[0rem] px-[14rem] bg-[#d8d6dd]  mt-16  ">
      <div className="bg-[#1F0F53] text-center text-white">
      ...
      <div className=" bg-gradient-to-r from-[#ebd6a8] to-[#faf0f8]">
        ...
        <div
          className={`w-[33rem] h-[35rem] bg-gray-500 text-white text-center flex items-center justify-center transform-gpu ${
            isShifted
              ? "translate-x-[34rem] transition-transform duration-1000 bg-[url('https://miro.medium.com/v2/resize:fit:1400/1*suK-y6ddujvd3-_k62_yiw.png')] "
              : "translate-x-[-0rem]  transition-transform duration-1000 bg-[url('https://marmotamaps.com/de/fx/wallpaper/download/faszinationen/Marmotamaps_Wallpaper_Berchtesgaden_Smartphone_1080x1920.jpg')]"
